...
public class FamilyTree
{
    private static class TreeNode
    {
        ...
        {
            children.add(childNode); // Add childNode to children list
        ...
        ArrayList<TreeNode> collectAncestorsToList()
        {
            ...
            TreeNode currentNode = this.parent; // Start from this node's parent
            while (currentNode != null) {
                ancestors.add(currentNode);
                currentNode = currentNode.parent; // Move up to the next parent
            }
            return ancestors;
        }
    ...
    private void addLine(String line) throws TreeException
    {
        ...
        if (colonIndex < 0)
            throw new TreeException("Illegal line format");
